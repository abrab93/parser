 ...
 */
@Entity
public class LogLineHour implements Comparable<LogLineHour>, Serializable {
    ...
    public LogLineHour(Date dateLogLineSynthes, String ip, int sumPerHour) {
    ...
    @Override
    public int compareTo(LogLineHour o) {
    ...
    public boolean equals(Object obj) {
        ...
        final LogLineHour other = (LogLineHour) obj;
